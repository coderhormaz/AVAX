      ...
      <div className="card">
        <div className="card-content">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h3 className="text-lg font-semibold text-primary">AVAX Wallet</h3>
              <p className="text-sm text-secondary">Avalanche C-Chain</p>
            </div>
          </div>
          ...
          <div className="mb-6">
            <div className="flex items-baseline gap-2 mb-2">
              ...
              <span className="text-lg text-secondary">AVAX</span>
            </div>
            {!hasMinBalance && (
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center gap-2">
              <div className="flex-1 bg-bg-input border border-border-primary rounded px-3 py-2 text-sm font-mono">
            ...
            {copied && (
              <p className="text-sm text-brand-orange mt-1">Address copied!</p>
            )}
          </div>
          ...
          <div className="modal qr-modal" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              <div className="qr-header">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-primary">Receive AVAX</h2>
                  <p className="text-sm text-secondary">Scan QR code or copy address below</p>
                </div>
              </div>
              <button
